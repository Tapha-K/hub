...
- 2026-07-27: 로컬 Google 로그인 성공을 실제 브라우저에서 확인했습니다.
- 책 등록부터 글귀 기반 재개까지 표의 2–11단계와 접근성 점검은 아직 전체 완료 전이며 [Issue #25](https://github.com/Tapha-K/hub/issues/25)에서 추적합니다.
